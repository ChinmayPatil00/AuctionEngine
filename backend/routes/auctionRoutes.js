...
const { createAuction, getActiveAuctions, getUpcomingAuctions, getEndedAuctions, getAuctionById, seedAuctions } = require('../controllers/auctionController');
const { protect } = require('../middleware/authMiddleware');

router.get('/seed', seedAuctions); // Secret route to seed DB
