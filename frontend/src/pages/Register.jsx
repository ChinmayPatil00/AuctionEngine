    ...
    <div className="flex flex-col md:flex-row min-h-[85vh] animate-fade-in-down border border-gray-800 rounded-lg overflow-hidden bg-surface mt-4 shadow-2xl">
      ...
      <div className="w-full md:w-1/2 relative bg-black hidden md:flex flex-col justify-between p-12 overflow-hidden group">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=1000&auto=format&fit=crop" alt="Luxury Assets" className="w-full h-full object-cover opacity-30 group-hover:opacity-40 transition-opacity duration-1000 grayscale" />
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-500 text-sm">
              Already have an account? <Link to="/login" className="text-white hover:text-accent font-bold transition-colors">Login Here</Link>
            </p>
          </div>
        </div>
      </div>
